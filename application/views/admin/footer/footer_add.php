                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="<?php echo base_url('Footer_Add_Act'); ?>" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1">Description 1th</label>
                                                        <textarea name="desc1th" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1">Description 2th</label>
                                                        <textarea name="desc2th" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                                                    </div>
                                                    <div class="form-group">
