            ...
            <!-- MAIN CONTENT-->
                        <div class="main-content">
                            <div class="section__content section__content--p30">
                                <div class="row">
                                        <div class="col-md-12">
                                        <h3 class="title-5 m-b-35">About - Section Create</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="<?php echo base_url('AboutAddAct'); ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="email3" name="span" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- <div class="form-actions form-group" style="float: right;">
                                                        <button type="submit" class="btn btn-outline-success">Create</button></div> -->
                                                </form>
                                            </div>
                                        </div>
                                    </div>
