                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="<?php echo base_url('AboutEditAct/'.$span_edit['id']); ?>" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Span</div>
                                                            <input type="text" id="username3" name="span" class="form-control" required value="<?php echo $span_edit['span']; ?>">
                                                        </div>
                                                    </div>
