            ...
            <!-- MAIN CONTENT-->
                        <div class="main-content">
                            <div class="section__content section__content--p30">
                                <div class="row">
                                        <div class="col-md-12">
                                        <h3 class="title-5 m-b-35">Home - Banner Section</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="<?php echo base_url('BannerAddAct'); ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="password3" name="videourl" class="form-control">
                                                        </div>
                                                    </div>
