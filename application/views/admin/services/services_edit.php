                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="<?php echo base_url('ServicesEditAct/'.$services_edit['id']); ?>" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Title</div>
                                                            <input type="text" id="username3" name="title" class="form-control" required value="<?php echo $services_edit['title']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleTextarea1">Description</label>
                                                        <textarea name="span" class="form-control" id="exampleTextarea1" rows="4"><?php echo $services_edit['span']; ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <label for="click">
                                                    ...
                                                    <?php if($services_edit['file']){ ?>
                                                        <img style="object-fit: cover; width: 150px; height: 150px;" src="<?php echo base_url('uploads/admin/servicesfile/'.$services_edit['file']); ?>">
                                                    <?php }else{ ?>
