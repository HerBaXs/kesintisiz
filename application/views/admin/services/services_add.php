            ...
            <!-- MAIN CONTENT-->
                        <div class="main-content">
                            <div class="section__content section__content--p30">
                                <div class="row">
                                        <div class="col-md-12">
                                        <h3 class="title-5 m-b-35">Services - Section Create</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body card-block">
                                                <form action="<?php echo base_url('ServicesAddAct'); ?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="span" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <label for="click">
